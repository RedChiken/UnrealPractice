...
#include "RPG/RPGCharacterBase.h"
#include "RPG/RPGCharacterMovementComponentBase.h"

// Sets default values
ARPGCharacterBase::ARPGCharacterBase(const FObjectInitializer& ObjectInitializer) 
	: Super(ObjectInitializer.SetDefaultSubobjectClass<URPGCharacterMovementComponentBase>(ACharacter::CharacterMovementComponentName))
{
